        ...
        <div className="h-full flex flex-col">
          ...
          <div className="px-8 py-6 border-b border-[#d4cec4] flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span
                style={{ fontFamily: "Playfair Display, serif" }}
                className="text-[#3a3735] tracking-tight"
              >
                NextLoop
              </span>
            </div>
              ...
              <div>
                ...
                <ul className="space-y-1">
                  <li>
                    <a
                      href="#"
                      className="flex items-center gap-3 px-4 py-3 text-[#3a3735] hover:bg-[#f5f1ea] hover:text-[#c8a882] transition-colors"
                    >
          ...
          <div className="px-8 py-6 border-t border-[#d4cec4]">
            <p className="text-[#5a524b] text-xs">© 2026 NextLoop</p>
          </div>
        </div>
      </aside>
    </>
