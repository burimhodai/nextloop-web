              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-4 text-sm">
                    <div>
                      <p className="text-[#5a524b] mb-1">Current Bid</p>
                      <p className="text-[#3a3735]">${bid.currentBid.toLocaleString()}</p>
                    </div>
                    <div>
                      <p className="text-[#5a524b] mb-1">Your Max Bid</p>
                  ...
                  <button className="bg-[#3a3735] hover:bg-[#c8a882] text-[#faf8f4] hover:text-[#3a3735] px-6 py-2 text-sm transition-colors tracking-wide">
                    {bid.status === 'Leading' ? 'Increase Bid' : 'Place Higher Bid'}
                  </button>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-4 text-sm">
                    <div>
                      <p className="text-[#5a524b] mb-1">Final Price</p>
                      <p className="text-[#c8a882]">${auction.price.toLocaleString()}</p>
                    </div>
                    <div>
                      <p className="text-[#5a524b] mb-1">Payment</p>
                    ...
                    <div>
                      <p className="text-[#5a524b] mb-1">Shipping</p>
                    ...
                    {auction.trackingNumber && (
                      <div>
                        <p className="text-[#5a524b] mb-1">Tracking</p>
